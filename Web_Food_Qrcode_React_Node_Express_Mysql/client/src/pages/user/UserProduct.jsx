      ...
      <div className="container mx-auto px-4 py-8 pt-18 relative">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-orange-900 via-black/90 to-orange-800 text-white px-6 py-4">
            ...
            <p className="text-orange-100">โต๊ะที่ 7</p>
          </div>
                      ...
                      <div className="flex-1 flex flex-col md:flex-row gap-4">
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            {/* ส่วนอื่นๆ ที่ต้องการแสดง */}
                            {/* 
        <div className="text-gray-500">ระดับการเสิร์ฟ:</div>
        <div>{item.specialRequest || "ธรรมดา"}</div>
        
        <div className="text-gray-500">หมายเหตุ:</div>
        <div>{item.note || "ไม่มี"}</div>
        
        <div className="text-gray-500">ไข่:</div>
        <div>{item.egg || "ไม่ใส่"}</div>
        
        <div className="text-gray-500">จำนวน:</div>
        <div>{item.quantity || "1"} รายการ</div>
        */}
                          </div>
                        </div>
